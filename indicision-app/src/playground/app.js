class IndecisionApp extends React.Component {
  constructor(props) {
    ...
    this.handAddOption = this.handAddOption.bind(this);
...
//State component or Class based component
/*
...
//This is stateless functional component, using props and no use for THIS key word.
const Action = (props) => {
  return (
    <div>
...
//This is state component or Class based component
/*
...
class AddOption extends React.Component {
  ...
  handleAddOption(e) {
    ...
    const error = this.props.handAddOption(option);
